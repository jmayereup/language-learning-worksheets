...
<article class="tj-worksheet-compiled prose max-w-none p-4 sm:p-6 bg-white rounded-3xl shadow-sm border border-gray-100">
  <header class="tj-worksheet-header mb-6">
