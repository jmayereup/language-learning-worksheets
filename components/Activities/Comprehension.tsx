...
export const Comprehension: React.FC<Props> = ({ data, readingText, onChange, savedAnswers }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center">
              <div className="mb-6 min-h-[120px]">
                  <p className="text-lg md:text-xl font-medium text-gray-800 mb-6">{currentQuestion.text}</p>
